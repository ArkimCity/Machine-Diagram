...
<script type="module">
    ...
    // loader.load( '../assets/json/gentilis_regular.typeface.json', function ( font ) {
        // init( font );
    ...
    function init( ) {
        ...
        // container = document.getElementById('canvasview');
        container = document.createElement('div');
        document.getElementById("canvasview").appendChild( container );
